...
#define REG_BASE  *(volatile unsigned short *) 0x4000000
#define MODE3 3
...
static inline void VBlankIntrWait(void)    { SystemCall(5); }
...
// void fillCircleDMA(int x, int y, int r, volatile u16 color);
void partialImageBackgroundDMA(int x, int y, int width, int height, const u16 *image);
